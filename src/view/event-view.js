              ...
              <div class="event">
                ...
                <div class="event__schedule">
                  <p class="event__time">
                    ...
                    &mdash;
                    <time class="event__end-time" datetime="${getDatetime(dateTo)}">${humanizeEventTime(dateTo)}</time>
                  </p>
                ...
                ${offers.length ? createOffersEventTemplate(offers) : ''}
...
export default class EventView extends AbstractView {
  ...
  constructor({ event, destination, offers, onClick }) {
    super();
    this.#event = event;
