...
const getEventsInfoTemplate = ({ destinationsInfo, datesInfo, priceInfo }) => `<section class="trip-main__trip-info  trip-info">
...
export default class EventsInfoView extends AbstractView {
  ...
  get template() {
    return getEventsInfoTemplate({ ...this.#infoData });
  }
}
